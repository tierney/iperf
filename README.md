...
The historical use case was a client that could initiate outbound connections but could not accept inbound test connections.
This fork's reverse mode flips data direction over the established path.
